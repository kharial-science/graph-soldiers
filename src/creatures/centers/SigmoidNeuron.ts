...
import Center, { CenterInputWeights } from "../Center"
...
export default class SigmoidNeuron extends Center {
    ...
    public evolveInnerWeights(weightFactor: number): void {
        this.innerWeights.bias +=
            weightFactor * this.innerWeightsFactors.bias * random()
        this.innerWeights.gain +=
            weightFactor * this.innerWeightsFactors.gain * random()
    }
